<template>
    <v-sheet class="m-0 m-n2" elevation="6">
        <v-tabs v-model="tab" color="purple-accent-4" align-tabs="center">
            ...
            <v-tab value="timeline" @click="showTable('timeline')"> Transactions</v-tab>

            <v-tab value="sales" @click="showTable('sales')">Sales</v-tab>
            <v-tab value="summary" @click="showTable('summary')"> Sales Summary</v-tab>
            <v-tab value="income" @click="showTable('income')"> Other Income</v-tab>
            <v-tab value="expenses" @click="showTable('expenses')">Expenses</v-tab>
            <v-tab value="transfer" @click="showTable('transfer')"> Fund Transfer</v-tab>
            ...
            <v-window-item :value="0">
                <v-card class="d-flex justify-center align-center">
                    <myDataTable :feature="feature" @search-by-date="getByDate" @search-by-range="getByRange"
                        @search="searchTable" @feature="getFeature" @edit="editItem" @delete="deleteItem" @view="showView"
...
function showTable(page: string, ev?: string) {
    ...
    switch (page) {
        case 'today':
            ...
            $api.post('/api/transactions/getByDate', { 'start': new Date() }).then((res) => {
