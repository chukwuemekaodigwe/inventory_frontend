 ...
 <v-row>
        <v-col>
            <v-card class="pa-2 py-0" rounded="lg" min-height="300">
                ...
                <GChart type="PieChart" :data="expense.chartData" :options="expense.chartOptions" v-if="getExpenses"
                    :key="4" />
            </v-card>
        </v-col>
    </v-row>
    ...
    <v-col cols="12" sm="6"  md="6" lg="6">
      <v-card class="pa-2" rounded="lg" min-height="300">
        <v-card-title class="">Today's Sales</v-card-title>
          ...
          <GChart type="PieChart" :data="sales.chartData" :options="sales.chartOptions" v-if="getSales" :key="1" />
