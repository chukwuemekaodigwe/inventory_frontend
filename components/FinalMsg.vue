      ...
      <v-dialog v-model="incomeDialog" persistent width="400px">
        <v-card>
          ...
          <v-card-text style="display: flex; justify-content: center; align-items: center; flex-flow: column nowrap;">
            ...
            <span class="text-center">Congratulations you've successfully completed your system setup. Proceed to customization page to select your system Colors!
              </span>
              <span> <a href="/systemCustomization">Click to Proceed</a>
              </span>
          </v-card-text>
          <v-card-actions>
            <v-spacer></v-spacer>
